...
const AboutBanner = () => {
  ...
  return (
    <section className="w-full h-[95vh]">
      ...
      >
        <div className="flex flex-col justify-center gap-30 all:drop-shadow-lg lg:flex lg:flex-row lg:gap-130">
          ...
          <div className="leading-wide sm:text-20 lg:text-24 font-light max-w-890 under:mt-[1em] break-keep">
            <p>

...
import ScrollOpenIcon from 'icons/shared_icon/scroll_open.icon.svg'
import ScrollCloseIcon from 'icons/shared_icon/scroll_close.icon.svg'
...
import StrategicIcon from 'icons/class_icon/strategic.icon.svg'
